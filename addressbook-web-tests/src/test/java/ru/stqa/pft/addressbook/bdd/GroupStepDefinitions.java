...
public class GroupStepDefinitions {
  ...
  @Given("^a set of groups$") //^...$ проверка точного соотвествия
  public void loadGroups() {
    groups = app.db().groups();

  }

  @When("^I create a new group with name (.+), header (.+) and footer (.+)$") //^...$ проверка точного соотвествия
  ...
  @Then("^the new set of groups is equal to the old set with added group$") //^...$ проверка точного соотвествия
